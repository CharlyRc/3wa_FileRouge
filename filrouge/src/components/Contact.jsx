...
const Contact = () => {
    ...
    return (
        <div className="container-localisation">
            <div>
                <h2 className="title-categories">Nos horaires</h2>
                <table>
                    <tbody>
                        <tr>
                            <td className='days'>Lundi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Mardi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Mercredi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Jeudi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Vendredi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Samedi</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                        <tr>
                            <td className='days'>Dimanche</td>
                            <td>09h00 - 18h00</td>
                        </tr>
                    </tbody>
                </table>
